...
{{/*
Create the name of the service auth to use
*/}}
{{- define "auth-app-chart.serviceauthName" -}}
{{- if .Values.serviceauth.create }}
{{- default (include "auth-app-chart.fullname" .) .Values.serviceauth.name }}
{{- else }}
{{- default "default" .Values.serviceauth.name }}
{{- end }}
{{- end }}
